...
class M_cetak extends CI_Model {
    ...
    function get_peserta($id) {
        $sql = 'SELECT noref,custname,adrs,jobtitle,dob,ktp,premi,tsi,transdate,enddate,priod,type,policyinsuranceno,policyurl,statuspolicy,nobatch
        FROM m_peserta 
        WHERE id_peserta = "' . $id . '"';
