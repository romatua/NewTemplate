...
class Formapp extends MX_Controller {
    ...
    public function readytoclaim() {
        ...
        $crud
                ...
                ->set_relation('id_payment', 'm_payment', 'sts_payment');

        $crud->where('nomor_polis IS NOT NULL AND m_peserta.id_status_transaksi in (2,3) '
                . ' AND m_peserta.id_payment IN (1,2,3) '
...
//        $crud->order_by('id_peserta','desc');
        ...
        if ($state == 'export') {
            $crud->columns('no', 'kc_kcp', 'nomor_PK', 'nomor_rekening', 'nomor_polis', 'nik', 'nama_peserta', 'tmp_lahir', 'tgl_lahir', 'id_jeniskelamin', 'masa_asuransi', 'days_asuransi', 'tgl_mulai', 'tgl_akhir', 'nilai_pertanggungan', 'usia_jatuhtempo', 'premi');
        } else {
        ...
        $crud->set_read_fields('kc_kcp', 'nomor_PK', 'nomor_rekening', 'nomor_polis', 'nik', 'nama_peserta', 'tmp_lahir', 'tgl_lahir', 'id_jeniskelamin', 'masa_asuransi', 'tgl_mulai', 'tgl_akhir', 'nilai_pertanggungan', 'premi', 'created_by', 'created_date');
        ...
        $crud
                ...
                ->display_as('nomor_rekening', 'Loan Number')
                ...
                ->display_as('created_date', 'Create Date');
...
//        $crud->add_action('Klaim', '', 'klaim/pengajuan/add', 'print target');
        $crud->add_action('Klaim', '', '', 'claim', function ($primary_key, $row) {
...
//        $crud->order_by('id_peserta', 'desc');
        ...
        //$crud->add_fields('nomor_polis','Jenis_pertanggungan','nama_peserta','tgl_lahir','usia_masuk','jenis_kelamin','id_kredit','grace_priode','masa_asuransi','tgl_mulai','tgl_akhir','nilai_pertanggungan');
        if ($state == 'export') {
            $crud->columns('no', 'kc_kcp', 'nomor_PK', 'nomor_rekening', 'id_jeniskredit', 'nik', 'nama_peserta', 'tmp_lahir', 'tgl_lahir', 'id_jeniskelamin', 'masa_asuransi', 'tgl_mulai', 'tgl_akhir', 'nilai_pertanggungan', 'premi');
        } else {
            $crud->columns('kc_kcp', 'nama_peserta', 'tgl_lahir', 'tgl_mulai', 'tgl_akhir', 'nilai_pertanggungan', 'premi');
            $crud->callback_column('nilai_pertanggungan',function($value){ return number_format($value, 2, ",", "."); });
            $crud->callback_column('tarif_premi',function($value){ return number_format($value,3); });
            $crud->callback_column('premi',function($value){ return number_format($value, 2, ",", "."); });
        ...
        $crud->edit_fields('kc_kcp', 'nomor_PK', 'nomor_rekening', 'id_jeniskredit', 'nik', 'nama_peserta', 'tmp_lahir', 'tgl_lahir', 'id_jeniskelamin', 'masa_asuransi', 'tgl_mulai', 'tgl_akhir', 'nilai_pertanggungan', 'premi');
        $crud->set_read_fields('kc_kcp', 'nomor_PK', 'nomor_rekening', 'id_jeniskredit', 'nik', 'nama_peserta', 'tmp_lahir', 'tgl_lahir', 'id_jeniskelamin', 'masa_asuransi', 'tgl_mulai', 'tgl_akhir', 'nilai_pertanggungan', 'usia_jatuhtempo', 'premi', 'created_by', 'created_date');
...
//        $crud->order_by('id_peserta', 'desc');
        ...
        if ($state == 'export') {
            $crud->columns('no', 'kc_kcp', 'nomor_PK', 'nomor_rekening', 'id_jeniskredit', 'nomor_polis', 'nik', 'nama_peserta', 'tmp_lahir', 'tgl_lahir', 'id_jeniskelamin', 'masa_asuransi', 'tgl_mulai', 'tgl_akhir', 'nilai_pertanggungan', 'premi');
        } else {
            $crud->columns('kc_kcp', 'nama_peserta', 'tgl_lahir', 'tgl_mulai', 'tgl_akhir', 'nilai_pertanggungan', 'premi');
            $crud->callback_column('nilai_pertanggungan',function($value){ return number_format($value, 2, ",", "."); });
            $crud->callback_column('tarif_premi',function($value){ return number_format($value,3); });
        ...
        $crud->edit_fields('kc_kcp', 'nomor_PK', 'nomor_rekening', 'id_jeniskredit', 'nomor_polis', 'nik', 'nama_peserta', 'tmp_lahir', 'tgl_lahir', 'id_jeniskelamin', 'masa_asuransi', 'tgl_mulai', 'tgl_akhir', 'nilai_pertanggungan', 'premi');
        $crud->set_read_fields('kc_kcp', 'nomor_PK', 'nomor_rekening', 'id_jeniskredit', 'nomor_polis', 'nik', 'nama_peserta', 'tmp_lahir', 'tgl_lahir', 'id_jeniskelamin', 'masa_asuransi', 'tgl_mulai', 'tgl_akhir', 'nilai_pertanggungan', 'premi', 'created_by', 'created_date');
        ...
        $crud->add_action('Cetak Sertifikat', '', 'cetak/sertifikat', 'print target', $url_callback_print);
//        $crud->add_action('Klaim', '', 'klaim/pengajuan/add', 'print target');
...
//        $crud->order_by('id_peserta', 'desc');
        ...
        if ($state == 'export' ) {
			//echo 'test'; die();
            $crud->columns('no','kc_kcp','id_jeniskredit','nomor_polis','nik','nama_peserta','tmp_lahir','tgl_lahir','usia_masuk','id_jeniskelamin','masa_asuransi','days_asuransi','tgl_mulai','tgl_akhir','nilai_pertanggungan','usia_jatuhtempo','premi');
        } else {        
            $crud->columns('nama_peserta','tgl_lahir','tgl_mulai','tgl_akhir','nilai_pertanggungan','premi');
            $crud->callback_column('nilai_pertanggungan',function($value){ return number_format($value, 2, ",", "."); });
            $crud->callback_column('tarif_premi',function($value){ return number_format($value,3); });
            $crud->callback_column('premi',function($value){ return number_format($value, 2, ",", "."); });
...
#End approve_kondisi_a
    ...
    public function daftar_percabang() {
        ...
        $crud
                ...
                ->set_primary_key('kc_kcp', 'm_peserta_percabang');
        ;

        if (!$this->ion_auth->in_group(array('admin', 'cabangjasindo', 'manajemen', 'adminbank'))) {
            $crud->where('m_peserta_percabang.kc_kcp = "' . $user->kc_kcp . '" AND 1 = ', "1");
        }
//        $crud->order_by('kc_kcp', 'desc');
        ...
        if ($state == 'export') {
            ...
            $crud->columns('no', 'kc_kcp', 'nilai_pertanggungan', 'premi', 'jumlah_peserta');
        } else {
            $crud->columns('kc_kcp', 'nilai_pertanggungan', 'premi', 'jumlah_peserta');
            $crud->callback_column('nilai_pertanggungan',function($value){ return number_format($value, 2, ",", "."); });
            $crud->callback_column('jumlah_peserta',function($value){ return number_format($value,0); });
            $crud->callback_column('premi',function($value){ return number_format($value, 2, ",", "."); });
        ...
        $crud->set_read_fields('kc_kcp', 'nilai_pertanggungan', 'premi', 'jumlah_peserta');
        $crud->fields('kc_kcp', 'nilai_pertanggungan', 'premi', 'jumlah_peserta');
