        ...
        <ul class="nav side-menu">
            ...
            <li>
                ...
                <ul class="nav child_menu">
                    <?php
                    if ($this->ion_auth->in_group(array('admin', 'cabangjasindo', 'adminbank', 'cabangbank'))) {
                        ?>
                        <li><a href="<?= site_url('/uploadpeserta'); ?>">Upload Calon Peserta</a></li>
                    <?php } ?>
                    <?php
                    if ($this->ion_auth->in_group(array('admin', 'cabangjasindo'))) {
                        ?>
                        <li><a href="<?= site_url('/uploadapproval'); ?>">Upload Approval</a></li>
                    <?php } ?>
