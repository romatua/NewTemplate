...
class Auth extends MX_Controller {
    ...
    public function index() {
        if (!$this->ion_auth->logged_in()) {
            ...
            if ($this->ion_auth->in_group('adminbank')) {
                $groups = array("3", "4");
            }
            //note be carefull if 1 person can have 2 groups!
            //
            ...
            $data['subview'] = 'auth/index'; //'views/manager_user/index';
    ...
    public function login() {
        ...
        if ($this->form_validation->run() == true) {
            ...
            if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember)) {
                ...
                redirect('/', 'refresh');
                /*redirect('dashboard/dashboard_manajemen', 'refresh');*/
            } else {
            ...
            $this->_render_page('auth/login_ultra', $data);
        }
    }
    ...
    public function create_user() {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $group_ids = array($this->input->post('groups'));
        }
    ...
    public function edit_user($id) {
        ...
        if (isset($_POST) && !empty($_POST)) {
            // do we have a valid request?
            if ($this->_valid_csrf_nonce() === FALSE || $id != $this->input->post('id')) {
                show_error($this->lang->line('error_csrf') . var_dump($user) . " " . $id . " XXX " . $this->input->post('id') . " - " . $this->_valid_csrf_nonce());
            }
